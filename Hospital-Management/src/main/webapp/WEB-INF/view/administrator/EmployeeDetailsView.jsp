				...
				<div class="sidenav">
					<a><br /> <br />
						<div style="background-color: rgba(255, 0, 0, 0.4);">
							&nbsp;&nbsp;&nbsp; <span class="badge badge-pill badge-warning">&nbsp;&nbsp;<%=l.getRole().toUpperCase()%>&nbsp;&nbsp;
							</span><br /> <br /> <b>Username:</b>
							<%=l.getUsername()%><br /> <br />
							<!--<b>Id:</b>l.getId()d() %><br/>-->
							<a href="editView.html"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
								style="text-decoration: underline; color: green;">edit...</span>
							</a>
						</div> </a><br />
					...
					<a href="addEmployeeView.html">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add Employee </a> <a
						href="searchEmployeeView.html">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search Employee </a> <a
						href="allEmployeesView.html">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All Employees </a>
					<%
					}
					%>
					...
					<table class="table table-striped table-bordered">
						<tbody>
							<tr>
								...
								<!-- getters r used to access values -->
							</tr>
							<tr>
							...
							<tr>
								...
								<td>${ employee.name.firstName }&nbsp;&nbsp; ${ employee.name.middleName }
									&nbsp; &nbsp; ${ employee.name.lastName }</td>
								<!-- getters r used to access values -->
							</tr>
							<tr>
							...
							<tr>
								...
								<td><span class="font-weight-bold"> Residential
										Address :</span><br> ${ employee.address.residentialAddress } <br>
									<br> <span class="font-weight-bold"> Permanent
										Address :</span><br> ${ employee.address.permanentAddress }</td>
								<!-- getters r used to access values -->
							</tr>
							<tr>
